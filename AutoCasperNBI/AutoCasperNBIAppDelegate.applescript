    ...
    on checkJSSURL_(sender)
        ...
        -- Make sure jssURL has a value before we proceed
            ...
            try
                ...
                set jssURLHtml to do shell script "/usr/bin/curl -k " & jssURL & "/api/ClientImaging/Test -m 30"
                --Log Action
...
-- Deletes launchAgent that triggers "New to Mac?" notification
    ...
    try
        ...
        set logMe to "CloneDeploy Url: " & jssURL & "/api/ClientImaging/"
        logToFile_(me)
        ...
        do shell script "/bin/echo " & jssURL &  "/api/ClientImaging/ > " & quoted form of netBootDmgMountPath & "/usr/local/bin/weburl" user name adminUserName password adminUsersPassword with administrator privileges
